...
type TurnoverForPortfolioApiService service

/*
TurnoverForPortfolioApiService turnover for portfolio
 ...
 * @param optional nil or *TurnoverForPortfolioApiPortfolioTurnoverFyFromDateToDateGetOpts - Optional Parameters:
...
type TurnoverForPortfolioApiPortfolioTurnoverFyFromDateToDateGetOpts struct {
	UserId        optional.String
	ClientAccount optional.String
}

func (a *TurnoverForPortfolioApiService) PortfolioTurnoverFyFromDateToDateGet(ctx context.Context, consumerKey string, sessionToken string, fy string, fromDate string, toDate string, localVarOptionals *TurnoverForPortfolioApiPortfolioTurnoverFyFromDateToDateGetOpts) ([]InlineResponse2006, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/portfolio/turnover/{fy}/{fromDate}/{toDate}"
