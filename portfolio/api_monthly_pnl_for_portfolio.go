...
type MonthlyPnlForPortfolioApiService service

/*
MonthlyPnlForPortfolioApiService Monthly for portfolio
 ...
 * @param optional nil or *MonthlyPnlForPortfolioApiPortfolioMonthlypnlFyFromDateToDateGetOpts - Optional Parameters:
...
type MonthlyPnlForPortfolioApiPortfolioMonthlypnlFyFromDateToDateGetOpts struct {
	UserId        optional.String
	ClientAccount optional.String
}

func (a *MonthlyPnlForPortfolioApiService) PortfolioMonthlypnlFyFromDateToDateGet(ctx context.Context, consumerKey string, sessionToken string, fy string, fromDate string, toDate string, localVarOptionals *MonthlyPnlForPortfolioApiPortfolioMonthlypnlFyFromDateToDateGetOpts) ([]InlineResponse2007, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/portfolio/monthlypnl/{fy}/{fromDate}/{toDate}"
